        ...
        <Divider orientation="left" style={welcomeStyle}>Popular Movies</Divider>
          <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
            <Col className="movie-grid" span={6}>
              <div className="movie-title" style={style}>Enola Holmes</div>
              <img src="https://images.everyeye.it/img-cover/enola-holmes-v2-42739-340.jpg" alt="enola" style={gridStyle}></img>
            </Col>
            <Col className="movie-grid" span={6}>
              <div className="movie-title" style={style}>O Diabo de Cada Dia</div>
            ...
            <Col className="movie-grid" span={6}>
              <div className="movie-title" style={style}>Tenet</div>
            ...
            <Col className="movie-grid" span={6}>
              <div className="movie-title" style={style}>Mulan</div>
